...
const ELECTION_EXP_TYPES: ExpType1[] = [
  ...
  { label: "공개장소연설대담", level2: [
    { label: "차량", level3: ["임차비", "유류비", "기사인부임", "기타"] },
    ...
    { label: "녹화기", level3: ["LED전광판임차비", "녹화물제작비", "기타"] },
  ...
  { label: "기타", level2: [{ label: "위법비용", level3: ["위법비용"] }] },
];

const NON_ELECTION_EXP_TYPES: ExpType1[] = [
  { label: "선거사무소", level2: [
    { label: "임차보증금", level3: [] }, { label: "사무집기류임차비", level3: [] },
    { label: "소모품구입비", level3: [] }, { label: "내외부설치유지비", level3: [] },
    { label: "인건비", level3: [] },
    { label: "개소식관련", level3: ["다과비", "초대장발송비", "기타"] },
    { label: "기타", level3: [] }, { label: "유지비용", level3: ["관리비"] },
  ]},
  { label: "납부금", level2: [
    { label: "기탁금", level3: [] }, { label: "세대부명단교부비", level3: [] }, { label: "기타", level3: [] },
  ]},
  { label: "예비후보자공약집", level2: [{ label: "예비후보자공약집", level3: [] }] },
  { label: "기타차량", level2: [
    { label: "선거벽보/공보/공약서부착차량", level3: ["임차비", "유류비", "기사인건비", "기타"] },
    { label: "후보자승용자동차", level3: ["임차비", "유류비", "기사인건비", "기타"] },
  ]},
  { label: "후보자등숙박비", level2: [{ label: "숙박비", level3: [] }] },
  { label: "선거운동준비비용", level2: [
    { label: "컨설팅비용", level3: [] }, { label: "여론조사비용", level3: [] }, { label: "기타", level3: [] },
  ]},
  { label: "기타", level2: [{ label: "기타", level3: [] }] },
];
...
const PAY_METHODS = [
  { value: "118", label: "계좌입금" }, { value: "119", label: "카드" },
  { value: "120", label: "현금" }, { value: "583", label: "수표" },
  { value: "584", label: "신용카드" }, { value: "585", label: "체크카드" },
];
