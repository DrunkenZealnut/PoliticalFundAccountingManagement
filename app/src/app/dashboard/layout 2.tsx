...
export default function DashboardLayout({
  ...
  const { user, orgName, orgType, orgId, setUser } = useAuth();
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r overflow-y-auto flex-shrink-0">
        <div className="p-4 border-b">
          <h1 className="font-bold text-lg">정치자금 회계관리</h1>
          <p className="text-sm text-gray-500 truncate">{orgName || "기관 미선택"}</p>
        </div>
        <nav className="p-2">
