...
export const PAGE_GUIDES: Record<string, PageGuideData> = {
  ...
  submissionWizard: {
    pageId: "submission-wizard",
    title: "제출 서류 마법사 안내",
    summary:
      "선관위 제출 서류(수입·지출보고서 / 선거비용 보전신청서)를 점검부터 생성까지 한 번에 만드는 화면입니다.",
    steps: [
      "만들 서류(보고서 / 보전신청서) 카드를 선택",
      "준비 점검: 데이터 상태를 신호등(✅⚠️❌)으로 확인, ❌는 [고치러 가기]로 해결",
      "미리보기: 서식에 들어갈 숫자를 미리 확인",
      "만들기: 서식을 선택해 zip 파일 하나로 일괄 다운로드",
    ],
    tips: [
      "⚠️ 경고는 진행할 수 있지만, 제출 전에 해당 화면에서 원인을 확인하세요.",
      "미리보기의 숫자와 생성된 서식의 숫자는 같은 계산 기준이라 항상 일치합니다.",
      "개별 서식만 필요하면 기존 [제출서류 작성] 화면을 이용해도 됩니다.",
    ],
  },
};
