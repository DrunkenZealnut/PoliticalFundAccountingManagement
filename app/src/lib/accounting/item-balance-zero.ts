...
/*                                                                    */
/*  한계(환급 엣지): 환급(음수 지출)이 그 과목의 수입보다 커 순지출이     */
/*  음수인 과목은 구조적으로 0이 안 된다 — 환급은 과목 불변이라 그 과목에  */
/*  갇히고, 수입은 음수가 될 수 없어 그 과목 잔액이 +로 남는다. 이 경우    */
/*  자금원 총액이 0이어도(다른 과목의 −와 상쇄) 최선노력(가용 수입만       */
/*  이동)만 하고 잔여를 남긴다(plug 금지). 잔여 표면화(경고)는 후속.       */
/* ------------------------------------------------------------------ */
